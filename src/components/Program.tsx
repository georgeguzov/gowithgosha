...
const days = [
  {
    ...
    title: "Привет, Китай",
    city: "Чэнду",
    desc: "Встречаемся в Чэнду, заселяемся в отель и отправляемся на первую прогулку. Нас ждут современные кварталы города, огромная панда на крыше IFS и первый совместный ужин, где познакомимся друг с другом и попробуем настоящую сычуаньскую кухню.",
  ...
  },
  {
    ...
    city: "Чунцин",
    desc: "Сегодня исследуем самый необычный мегаполис Китая. Увидим легендарное метро, проходящее прямо сквозь жилой дом, прокатимся над рекой по канатной дороге и найдём лучшие панорамные виды. Вечером — атмосферные бары и ночные улицы.",
