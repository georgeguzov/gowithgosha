...
const stops = [
  { name: "Токио", lat: 35.6762, lng: 139.6503, day: "Дни 1–3", desc: "Осенние сады, Фудзи неподалёку, знакомство с группой" },
  { name: "Кавагутико", lat: 35.5019, lng: 138.7585, day: "День 3", desc: "Гора Фудзи, клёны у озера" },
  { name: "Киото", lat: 35.0116, lng: 135.7681, day: "Дни 4–6", desc: "Тысяча тории, бамбук, пик момидзи" },
  { name: "Нара", lat: 34.6851, lng: 135.8048, day: "День 7", desc: "Олени, храм Tōdai-ji" },
  { name: "Осака", lat: 34.6937, lng: 135.5023, day: "День 7", desc: "Dōtonbori, вечерний город" },
  { name: "Нисэко", lat: 42.8048, lng: 140.6874, day: "Дни 8–10", desc: "Снег, катание, онсэн" },
