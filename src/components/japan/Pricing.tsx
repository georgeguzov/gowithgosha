...
export default function Pricing() {
  ...
  return (
    <section ref={ref} id="booking" className="relative py-24 px-6 overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_80%_at_50%_50%,rgba(217,100,31,0.1),transparent)] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="mt-3 text-sm text-[#f5f0e8]/35">
            Предоплата для брони места — $400
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          ...
          <div className="space-y-6">
            ...
            <motion.div
              ...
              className="glass-amber rounded-3xl p-6 space-y-4"
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-[#f5f0e8]/50 uppercase tracking-widest mb-1">Даты</p>
                  <p className="text-xl font-bold text-[#f5f0e8]">22 ноября – 2 декабря 2026</p>
                </div>
              ...
              <div className="border-t border-white/[0.08] pt-4 flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-base font-semibold text-[#d4a843]">8 из 10</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        >
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-[#d9641f] via-[#e87b2e] to-[#d9641f] bg-[length:200%] animate-[shimmer_2s_linear_infinite]" />
          </a>
