...
const days = [
  ...
  },
  {
    day: 2,
    emoji: "🛍️",
    title: "Шоппинг и стритвир",
    city: "Токио",
    image: "/токио-шоппинг-харадзюку.jpg",
    desc: "Харадзюку, Шибуя, Симокитадзава — Токио один из мировых центров стритвира, и тут реально одеться так, как больше нигде. Оставь место в чемодане. Вечером наряжаемся в обновки и идём гулять по городу — с этого момента весь трип отчасти в новых образах.",
    highlights: ["Харадзюку", "Шибуя", "Симокитадзава"],
    snow: false,
  },
  {
    day: 3,
    ...
    desc: "Дневная поездка к озеру Кавагутико — момидзи вдоль берега, гора Фудзи как открыточный фон без единого облака (если повезёт с погодой — ловим лучший кадр всей поездки). Вечером возвращаемся в Токио.",
  ...
  },
  {
    ...
    desc: "Синкансэн Токио → Киото. По приезде — Fushimi Inari: тысячи оранжевых тории уходят вверх по склону горы, место, без которого невозможно представить Японию. Вечером — Kiyomizu-dera и прогулка по Гион, кварталу гейш, в закатном свете.",
    highlights: ["Синкансэн", "Fushimi Inari", "Гион"],
    snow: false,
  },
  {
    day: 5,
    ...
    desc: "Arashiyama — бамбуковая роща и клёны вдоль реки Хозугава, одно из самых фотогеничных мест страны. Вечером — ночная подсветка одного из храмов (Kōdai-ji или Eikan-dō, по факту цветения).",
  ...
  },
  {
    ...
    desc: "Утром едем в Нару налегке (чемоданы — в камере хранения на вокзале Киото): парк, где сотни ручных оленей кланяются за печенье, и храм Tōdai-ji с гигантским Буддой внутри. Вечером забираем вещи и едем в Осаку — Dōtonbori, неоновые вывески и лучшая уличная еда в стране.",
  ...
  },
  {
    ...
    desc: "Свободное утро в Осаке (замок или ещё немного шоппинга), днём перелёт в Саппоро — единственный аэропорт Хоккайдо, дальше около 1.5 часов трансфером до Нисэко. Долгий переездный день, но вечером уже ждёт первый онсэн.",
  ...
  },
  {
    ...
    desc: "Полный день катания в Niseko Grand Hirafu — тот самый японский пухляк, ради которого сюда едут райдеры со всего мира. Вечером — онсэн и ужин.",
  ...
  },
  {
    ...
    desc: "Ещё один день катания — можно остаться в Хирафу или заехать на соседний курорт (все рядом, инфраструктура единая).",
    highlights: ["Хирафу", "Соседние курорты", "Единая инфраструктура"],
    snow: true,
  },
  {
    day: 10,
    emoji: "🏔️",
    title: "Финальный день и большой дом",
    city: "Нисэко",
    image: "/нисэко-большой-дом.jpg",
    desc: "Третий день катания для желающих. Вечером — переезд всей группой в большой дом на ночь: последняя тусовка трипа, все вместе под одной крышей.",
    highlights: ["Третий день катания", "Большой дом", "Финальная тусовка"],
    snow: true,
  },
  {
    day: 11,
