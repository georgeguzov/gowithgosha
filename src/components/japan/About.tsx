...
const features = [
  ...
  { icon: "🎞️", title: "Плёнка и хендикам", desc: "Возьми плёночный фотоаппарат или хендикам — трип останется не только в сторис, но и в кадрах с настоящим film-вайбом. У кого нет — можно будет докупить или одолжить на месте." },
];
