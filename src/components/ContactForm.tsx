          ...
          {state === "success" ? (
            ...
            >
              ...
              <button
                ...
                className="w-full glass-red py-4 rounded-xl font-semibold text-[#f5f0e8] hover:bg-[#c8102e]/20 transition-[background-color,opacity] duration-300 disabled:opacity-50"
              >
